# IMPORTANT!
This is not my repository, and its being used by for learning puposes. All credits goes to Stanford University, original repository is: [stanford-tensorflow-tutorials](https://github.com/chiphuyen/stanford-tensorflow-tutorials.git)
